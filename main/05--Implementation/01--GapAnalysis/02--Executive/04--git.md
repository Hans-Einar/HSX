...
| --- | --- | --- | --- | --- |
| 2025-11-03 | pending | Event back-pressure metrics & slow-consumer handling | Codex | Tests: `C:/appz/miniconda/envs/py312/python.exe -m pytest python/tests/test_executive_sessions.py` |
