...
| 2025-11-08 | `7bafbba` | `toolchain: improve register allocation heuristics and expose metrics` | Codex | Tests: `PYTHONPATH=. pytest python/tests/test_register_allocation_metrics.py python/tests/test_build_determinism.py` |
