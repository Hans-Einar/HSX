...
| 2025-11-08 | `79c5840` | `toolchain: improve register allocation heuristics and expose metrics` | Codex | Tests: `PYTHONPATH=. pytest python/tests/test_register_allocation_metrics.py` |
