...
| 2025-11-08 | `<pending>` | `toolchain: lower llvm.{uadd,usub}.with.overflow` | Codex | Tests: `python -m pytest python/tests/test_hsx_llc_shift.py python/tests/test_hsx_llc_carry.py` |
