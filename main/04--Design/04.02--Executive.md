...
Module 0x06 provides executive control syscalls that HXE applications can invoke:

| Func | Mnemonic | R0 (input) | R1 | R2 | R3 | R0 (return) | Status |
|------|----------|------------|----|----|----|----|--------|
| 0x00 | EXEC_YIELD | - | - | - | - | 0 | Implemented |
| 0x01 | EXEC_SLEEP_MS | sleep_duration_ms | - | - | - | 0 | Implemented |

These are the syscalls that HXE applications invoke to cooperate with the scheduler. The executive handles these traps and manages task scheduling accordingly.
