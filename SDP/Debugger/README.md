...
`DBG-RF-004` with frozen Slices `DBG-SL-001-005-001..006` and corrected public-interface
candidate `dbg.resolver-inspection/1` awaiting `DBG-RVW-001-005-008`. Existing Executive behavior remains
