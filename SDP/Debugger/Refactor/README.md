...
| `DBG-RF-004` | Symbol/Source/Address/Inspection Model | BLOCKED / SLICES 001–002 SIGNED / STEERING FRAME-EVIDENCE GATE | DBG-D-003/D-004 + HSX-D-001..003 |
| `DBG-RF-005` | Breakpoint/Watch Ownership/Reconciliation | BLOCKED | DBG-RF-002 + DBG-RF-003 + accepted `dbg.resolver-inspection/1.1` from DBG-RF-004 |
...
Steering-refrozen `dbg.resolver-inspection/1.1` from issue #38 comment `5368017338`. Issue #42 comment `5362515750` durably clarifies that RF-005
