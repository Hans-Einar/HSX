...
Status: `rf004_interface_reviews_007_010_rework_corrected_review_012_pending`
...
007 through 010 returned REWORK; the corrected candidate must pass fresh review 012 before product
...
- `DBG-RVW-001-005-007..010` returned REWORK; Master completed documentation-only
  corrections and review 012 is pending.
...
`DBG-RVW-001-005-012` against that exact head, and only after PASS start
...
- Planned fresh interface review: `DBG-RVW-001-005-012`
...
- Active gate: publish and pass `DBG-RVW-001-005-012` on the corrected RF-004 interface
