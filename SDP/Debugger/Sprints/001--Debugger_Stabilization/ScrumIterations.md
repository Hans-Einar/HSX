...
Slice ownership and live traceability. Reviews 008..010 and 012..013 also returned REWORK;
fresh `DBG-RVW-001-005-014` must PASS before product
...
- Slice reviews: `DBG-RVW-001-005-001..006` and `DBG-RVW-001-005-011`; interface
  reviews: `DBG-RVW-001-005-007..010`, then `...012..014`; verifications
